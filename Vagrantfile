...
Vagrant.configure("2") do |config|
  ...
  # config.vm.network "forwarded_port", guest: 80, host: 8080
    ...
    config.vm.network "forwarded_port", guest: 80, host: 80 # [faqdev] HTTP/Web servers: Apache or Nginx
    config.vm.network "forwarded_port", guest: 3000, host: 3000 # [faqdev] Backend: Nodejs
  ...
  config.vm.provision :shell, path: "vagrant-preinstall.sh"
